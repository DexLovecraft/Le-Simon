...
const colors = ['red', 'yellow', 'blue', 'green', 'orange', 'purple', 'pink', 'teal', 'maroon','grey','bordeaux','plum','pine-green','sky-blue','duck-blue','gold']
let roundStep = 3 
let numberOfClick = -1
let score = 0
let numberOfsequence = 0
let highscore = localStorage.getItem("highscore")// game mechanics variable 
const difficultyLenght = 11
...
const scoreDisplay = () => {
  ...
  document.getElementsByClassName('highscore__number')[0].innerHTML = localStorage.getItem("highscore")
} 
